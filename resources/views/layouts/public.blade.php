    ...
    <head>
        ...
        @if (request()->routeIs('home'))
            <link
                rel="preload"
                as="image"
                href="{{ asset('images/optimized/banner-home-1024.avif') }}"
                imagesrcset="{{ asset('images/optimized/banner-home-640.avif') }} 640w, {{ asset('images/optimized/banner-home-1024.avif') }} 1024w"
        ...
        <style>
            ...
            header[role='banner'], #home-hero { content-visibility: visible; }
    ...
    <body class="bg-gray-50 text-slate-900 antialiased selection:bg-[#0033a0] selection:text-white">
        ...
        <div class="min-h-screen flex flex-col">
            ...
            <div class="fixed bottom-0 left-0 w-full z-50 lg:hidden" id="mobile-cta">
                <a href="{{ $waLink }}" class="flex items-center justify-center gap-3 theme-bg text-white w-full min-h-[64px] py-4 text-sm font-extrabold uppercase tracking-widest shadow-[0_-4px_10px_rgba(0,0,0,0.2)]">
